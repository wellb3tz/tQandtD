...
Start with [docs/README.md](docs/README.md). Public API entrypoints and examples are documented under `docs/`, and runnable TypeScript examples live in `examples/`.
